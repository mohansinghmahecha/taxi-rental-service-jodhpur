...
export default function RefundPolicy() {
  return (
    <div className="p-4">
      ...
      <p>Thank you for shopping at car tours jodhpur.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to car tours jodhpur.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to car tours jodhpur, accessible
            from
            <a
              href="https://cartoursjodhpur.com/"
           /*    rel="external nofollow noopener" */
             rel="noreferrer noopener"
              target="_blank"
            >
              https://cartoursjodhpur.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: toursshreeganesh5@gmail.com</li>
      </ul>
      <p>
